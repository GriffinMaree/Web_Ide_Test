sap.ui.define([
	...
	"Sites/model/formatter"
], function (Controller, formatter) {
	"use strict";

	return Controller.extend("Sites.controller.ThingPage", {
		formatter: formatter,
		onInit: function () {
		...
		_readDetailsService: function (oDetailsModel, sThingId) {
			...
			oDetailsModel.read("/Things('" + sThingId + "')", {
				urlParameters: {
					"$expand": "DYN_ENT_dapt_ox181026100231_vivotanks__Tank_Dip_Reading,DYN_ENT_dapt_ox181026100231_vivotanks__Image"
				},
